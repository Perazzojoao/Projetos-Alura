		...
		<section>
			...
			<div className={styles.sobreNos}>
				...
				<div className={styles.sobreNos__texto}>
					<p>
						Nós do Aluroni oferecemos a vocês, nossos queridos clientes, a Massa Italiana Caseira
						mais saborosa e sofisticada de São Paulo! Prezamos pelos ingredientes tradicionais da
						culinária Italiana, frescos e de excelente qualidade para que sua experiência seja ainda
						mais intensa!
					</p>
					<p>
			...
			<div className={styles.imagens}>
				{imagens.map((imagem, index) => (
					<div className={styles.imagens__imagem} key={index}>
						<img src={imagem} alt='Imagem da preparação' />
					</div>
				))}
			</div>
		</section>
