...
const ItemCarrinhoSuspenso = ({ itemCarrinho, removerProdutoCarrinho }) => {
  const { adicionarProduto, removerProduto, excluirProduto } = useCarrinhoContext();

	return (
		<li>
			<>
				<div className='produto'>
					<img className='imagem__produto' src={itemCarrinho.src} alt={itemCarrinho.alt} />
					...
					<Botao
						variant='deleteItem'
						aria-label='Excluir'
						onClick={() => excluirProduto(itemCarrinho.id)}>
						delete_forever
					</Botao>
				</div>
